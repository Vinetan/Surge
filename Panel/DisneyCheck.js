 ...
 */
 ...
 const DEFAULT_OPTIONS = {
   title: '𝗗𝗶𝘀𝗻𝗲𝘆+ 𝗖𝗵𝗲𝗰𝗸',
   availableContent: '𝗬𝗼𝘂 𝗰𝗮𝗻 𝘄𝗮𝘁𝗰𝗵 𝗗𝗶𝘀𝗻𝗲𝘆+ 𝗶𝗻 #REGION_CODE#',
   availableIcon: `checkmark.circle`,
   availableIconColor: '#1B813E',
   availableStyle: 'good',
   comingContent: '𝘿𝙞𝙨𝙣𝙚𝙮 𝙞𝙨 𝙘𝙤𝙢𝙞𝙣𝙜 𝙩𝙤 #REGION_CODE# 𝘀𝗼𝗼𝗻',
   comingIcon: 'exclamationmark.circle',
   comingIconColor: '#EFBB24',
   comingStyle: 'info',
   notAvailableContent: `𝗗𝗶𝘀𝗻𝗲𝘆+ 𝗱𝗼𝗲𝘀 𝗻𝗼𝘁 𝘀𝘂𝗽𝗼𝗿𝘁 𝘁𝗵𝗶𝘀 𝗜𝗣 𝗶𝗻 #REGION_CODE#`,
